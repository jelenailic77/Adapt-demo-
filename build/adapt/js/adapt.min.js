require(['bowser', 'underscore', 'backbone', 'semver', 'react', 'react-dom', 'html-react-parser', 'libraries/mediaelement-and-player', 'libraries/rangeslider', 'libraries/gsap.min', 'libraries/ScrollTrigger.min', 'libraries/lottie-player', 'libraries/lottie-interactivity.min', 'libraries/SCORM_API_wrapper', 'handlebars', 'libraries/lzma-min', 'libraries/lzma_worker-min.js'], (function (Bowser, _$1, Backbone$1, semver, React, ReactDOM, HTMLReactParser, mediaelementAndPlayer, rangeslider, gsap, ScrollTrigger, lottiePlayer, LottieInteractivity, pipwerks, Handlebars$1, lzmaMin, lzma_workerMin_js) { 'use strict';
  ...
  var AdaptModel = __AMD("core/js/models/adaptModel", class AdaptModel extends LockingModel {
    ...
    findRelativeModel(relativeString) {
      ...
      const rootModel = options.limitParentId ? data$1.findById(options.limitParentId) : Adapt$1.course;
      const relativeDescriptor = Adapt$1.parseRelativeString(relativeString);
  ...
  class BlockView extends AdaptView$1 {
    ...
    postRender() {
      this.screenHeight = device$1.getScreenHeight();

      _.defer(this.addChildren.bind(this));

      this.$el.css({
        "min-height": this.screenHeight,
        height: "auto"
      });
    }
  ...
  __AMD("components/adapt-cards/js/adapt-cards", Adapt$1.register('cards', {
    model: CardsModel,
    view: CardsView$1
  }));
  ...
  __AMD("components/adapt-choose/js/adapt-choose", Adapt$1.register('choose', {
    view: ChooseView$1,
    model: ChooseModel
  }));
  ...
  class AssessmentResultsView extends ComponentView$1 {
    ...
    reviewAnswer(e) {
      ...
      router$1.navigateToElement(`.${fristQuestion}`, {
        duration: 300
      });
      ...
      if (state._attemptsLeft) {
        ...
        $('.results-retakeCourse').removeClass('display-none');
      }
    }
  ...
  var BlankView = __AMD("components/adapt-contrib-blank/js/blankView", class BlankView extends ComponentView$1 {
    get template() {
      return 'blank';
    }
  ...
  var Flipcard = ComponentView$1.extend({
    events: {
      'click .flipcard__item': 'onClickFlipItem'
    },
    preRender: function () {
      this.listenTo(Adapt$1, 'device:resize', this.reRender, this);
      this.checkIfResetOnRevisit();
    },
    postRender: function () {
  ...
  Adapt$1.register('flipcard', Flipcard);
  __AMD("components/adapt-contrib-flipcard/js/adapt-contrib-flipcard", Flipcard);
  ...
  class HotgraphicPopupView extends Backbone.View {
    ...
    updatePageCount() {
      const template = Adapt$1.course.get('_globals')._components._hotgraphic.popupPagination || '{{itemNumber}} / {{totalItems}}';
  ...
  class NarrativeView extends ComponentView$1 {
    ...
    evaluateNavigation() {
      ...
      a11y$1.toggleEnabled($left, !isAtStart);
      a11y$1.toggleEnabled($right, !isAtEnd);
  ...
  var SliderView = __AMD("components/adapt-contrib-slider/js/sliderView", class SliderView extends QuestionView$1 {
    events() {
      return {
  ...
  class TextView extends ComponentView$1 {
    ...
    gsapTest() {
      ...
      console.log(ScrollTrigger__default["default"].version);
      ScrollTrigger__default["default"].matchMedia({
        "(min-width: 800px)": function () {
          gsap__default["default"].to('.bg-section', {
            scrollTrigger: {
              trigger: '.bg-section',
              start: '-450px center',
              end: '700px center',
          ...
          gsap__default["default"].to('.cards__item[data-index="0"]', {
            scrollTrigger: {
          ...
          gsap__default["default"].to('.cards__item[data-index="1"]', {
            scrollTrigger: {
          ...
          gsap__default["default"].to('.graphiccompare', {
            y: '0',
            opacity: '1',
            duration: 1.5,
            scrollTrigger: {
          ...
          gsap__default["default"].to('.narrative', {
            scrollTrigger: {
              trigger: '.narrative',
              start: '550px bottom',
              end: '750px bottom',
          ...
          gsap__default["default"].utils.toArray('.talk__chat-character-1').forEach(element => {
            gsap__default["default"].to(element, {
              scrollTrigger: {
                trigger: element,
                start: '0px center',
                end: '0px bottom',
          ...
          gsap__default["default"].utils.toArray('.talk__chat-character-2').forEach(ele => {
            gsap__default["default"].to(ele, {
              scrollTrigger: {
                trigger: ele,
                start: '0px center',
                end: '0px bottom',
  ...
  var FlexModel = __AMD("components/adapt-flex/js/FlexModel", class FlexModel extends ItemsComponentModel {
    checkIfResetOnRevisit() {
      this.resetActiveItems();
      super.checkIfResetOnRevisit();
      this.toggleItemsState(0);
  ...
  class FlexView extends ComponentView$1 {
    preRender() {
      this.onClick = this.onClick.bind(this);
  ...
  var FlexView$1 = __AMD("components/adapt-flex/js/FlexView", FlexView);

  __AMD("components/adapt-flex/js/adapt-flex", components$1.register('flex', {
    model: FlexModel,
    view: FlexView$1
  }));
  ...
  class GraphicCompareView extends ComponentView$1 {
    preRender() {
  ...
  var GraphicCompareView$1 = __AMD("components/adapt-graphicCompare/js/GraphicCompareView", GraphicCompareView);

  var GraphicCompareModel = __AMD("components/adapt-graphicCompare/js/GraphicCompareModel", class GraphicCompareModel extends ComponentModel$1 {
    defaults() {
      return ComponentModel$1.resultExtend('defaults', {
        _value: 50
      });
  ...
  __AMD("components/adapt-graphicCompare/js/adapt-graphicCompare", components$1.register('graphicCompare', {
    model: GraphicCompareModel,
    view: GraphicCompareView$1
  }));

  class LottieInteractivityView$1 extends ComponentView$1 {
    preRender() {
    ...
    postRender() {
      ...
      lottieplayer.addEventListener('ready', () => {
        Adapt$1.trigger('lottie:ready', this);
        this.setReadyStatus();
      });
      ...
      lottieplayer.addEventListener('play', () => {
        Adapt$1.trigger('lottie:play', this);
      });
      lottieplayer.addEventListener('pause', () => {
        Adapt$1.trigger('lottie:pause', this);
      });
  ...
  LottieInteractivityView$1.template = 'lottieInteractivity.jsx';
  var LottieInteractivityView$2 = __AMD("components/adapt-lottieInteractivity/js/LottieInteractivityView", LottieInteractivityView$1);

  var LottieInteractivityModel$1 = __AMD("components/adapt-lottieInteractivity/js/LottieInteractivityModel", class LottieInteractivityModel extends ComponentModel$1 {});

  __AMD("components/adapt-lottieInteractivity/js/adapt-lottieInteractivity", Adapt$1.register('lottieInteractivity', {
    model: LottieInteractivityModel$1,
    view: LottieInteractivityView$2
  }));

  var Model = ComponentModel$1.extend({
    getNavigationData: function () {
      ...
      for (var attrName in buttons) {
        ...
        if (buttonConfig._customRouteId) buttonModel = Adapt$1.findById(buttonConfig._customRouteId);
        item = buttonModel ? buttonModel.toJSON() : {
          '_isHidden': true
        };
    ...
    getReturnToPreviousLocation: function () {
      return Adapt$1.location._previousId ? Adapt$1.findById(Adapt$1.location._previousId) : null;
    },
    ...
    getSiblingPages: function () {
      ...
      siblingModels = _.filter(siblingModels, function (model) {
        return model.get('_type') === 'page' && model.get('_isAvailable') && (!this.get('_shouldSkipOptionalPages') || !model.get('_isOptional'));
      }, this);
    ...
    getPages: function () {
      ...
      switch (loopStyle) {
        case 'allPages':
          loop = true;
          descendants = Adapt$1.course.getAllDescendantModels(true);
          break;
  ...
  var Model$1 = __AMD("components/adapt-pageNav/js/model", Model);
  ...
  var Tooltip = Backbone.View.extend({
    ...
    removeOtherTooltips: function () {
      Adapt$1.trigger("tooltip:remove");
      Adapt$1.tooltip = this;
    },
    ...
    remove: function () {
      this.isRemoved = true;
      delete this.$target;
      delete Adapt$1.tooltip;
      $(document).off("mouseover", this.onBodyMouseOver);
      Backbone.View.prototype.remove.call(this);
    }
  });
  var Tooltip$1 = __AMD("components/adapt-pageNav/js/tooltip", Tooltip);
  ...
  var View = ComponentView$1.extend({
    events: {
    ...
    preRender: function () {
      ...
      this.listenTo(Adapt$1.contentObjects, {
    ...
    onButtonTooltip: function (event) {
      ...
      if (Adapt$1.tooltip) {
        ...
        var isCurrentTooltip = Adapt$1.tooltip.type === type && Adapt$1.tooltip.index === index;
      ...
      var tooltip = new Tooltip$1({
        $target: $target,
        model: Adapt$1.findById(id)
      });
      this.$('.pagenav__tooltip-container').append(tooltip.$el);
    },
    navigateTo: function (id) {
      var isCourse = id === Adapt$1.course.get('_id');
  ...
  var View$1 = __AMD("components/adapt-pageNav/js/view", View);

  __AMD("components/adapt-pageNav/js/adapt-pageNav", Adapt$1.register('pageNav', {
    model: Model$1,
    view: View$1
  }));
  ...
  class TabsView extends ComponentView$1 {
    ...
    get layout() {
      const layout = device$1.screenSize === 'large' ? this.model.get('_tabLayout') : 'vertical';
      return layout;
    }
  ...
  var AnimateMenuView = __AMD("extensions/adapt-animate/js/animate-menuView", class AnimateMenuView extends Backbone.View {
    initialize() {
      this.listenTo(Adapt$1, {
        'remove': this.remove,
      ...
      this.listenToOnce(Adapt$1, 'menuView:ready', this.render);
      this.listenTo(Adapt$1.config, 'change:_activeLanguage', this.remove);
    }
  ...
  var AnimateArticleView = __AMD("extensions/adapt-animate/js/animate-articleView", class AnimateArticleView extends Backbone.View {
    initialize() {
      this.listenTo(Adapt$1, 'remove', this.removeInViewListeners);
      this.listenTo(Adapt$1, 'popup:closed', this.notifyClosed);
      this.render();
    }

    render() {
      if (!Adapt$1.course.get('_animate')) return;
      this.firstRun = true;
      ...
      if (Adapt$1.course.get('_animate')._article._title._isEnabled) {
        this.titleEnabled = true;
        this.titleEffect = Adapt$1.course.get('_animate')._article._title._effect;
        this.titleDelay = Adapt$1.course.get('_animate')._article._title._delay;
      }
      ...
      if (Adapt$1.course.get('_animate')._article._body._isEnabled) {
        this.bodyEnabled = true;
        this.bodyEffect = Adapt$1.course.get('_animate')._article._body._effect;
        this.bodyDelay = Adapt$1.course.get('_animate')._article._body._delay;
      }
      ...
      if (Adapt$1.course.get('_animate')._article._instruction._isEnabled) {
        this.instructionEnabled = true;
        this.instructionEffect = Adapt$1.course.get('_animate')._article._instruction._effect;
        this.instructionDelay = Adapt$1.course.get('_animate')._article._instruction._delay;
      }
      ...
      if (Adapt$1.course.get('_animate')._article._custom._isEnabled) {
        this.customEnabled = true;
        this.customElement = Adapt$1.course.get('_animate')._article._custom._element;
        this.customEffect = Adapt$1.course.get('_animate')._article._custom._effect;
        this.customDelay = Adapt$1.course.get('_animate')._article._custom._delay;

        if (Adapt$1.course.get('_animate')._article._custom._items) {
          for (let i = 0, l = Adapt$1.course.get('_animate')._article._custom._items.length; i < l; i++) {
            this.customItems.push(Adapt$1.course.get('_animate')._article._custom._items[i]);
          }
        }
      }
    ...
    inview(event, visible, visiblePartX, visiblePartY) {
      if (visible) {
        ...
        if (this._isVisibleTop || this._isVisibleBottom && Adapt$1.animate.notifyIsOpen == false) {
          this.elementIsInView = true;

          if (!Adapt$1.animate.notifyIsOpen) {
            this.animateElements();
            this.removeInViewListeners();
          }
        } else {
  ...
  var AnimateBlockView = __AMD("extensions/adapt-animate/js/animate-blockView", class AnimateBlockView extends Backbone.View {
    initialize() {
      this.listenTo(Adapt$1, 'remove', this.removeInViewListeners);
      this.listenTo(Adapt$1, 'popup:closed', this.notifyClosed);
      this.render();
    ...
    render() {
      ...
      if (Adapt$1.course.get('_animate')._block._title._isEnabled) {
        this.titleEnabled = true;
        this.titleEffect = Adapt$1.course.get('_animate')._block._title._effect;
        this.titleDelay = Adapt$1.course.get('_animate')._block._title._delay;
      }
      ...
      if (Adapt$1.course.get('_animate')._block._body._isEnabled) {
        this.bodyEnabled = true;
        this.bodyEffect = Adapt$1.course.get('_animate')._block._body._effect;
        this.bodyDelay = Adapt$1.course.get('_animate')._block._body._delay;
      }
      ...
      if (Adapt$1.course.get('_animate')._block._instruction._isEnabled) {
        this.instructionEnabled = true;
        this.instructionEffect = Adapt$1.course.get('_animate')._block._instruction._effect;
        this.instructionDelay = Adapt$1.course.get('_animate')._block._instruction._delay;
      }
      ...
      if (Adapt$1.course.get('_animate')._block._custom._isEnabled) {
        this.customEnabled = true;
        this.customElement = Adapt$1.course.get('_animate')._block._custom._element;
        this.customEffect = Adapt$1.course.get('_animate')._block._custom._effect;
        this.customDelay = Adapt$1.course.get('_animate')._block._custom._delay;

        if (Adapt$1.course.get('_animate')._block._custom._items) {
          for (let i = 0, l = Adapt$1.course.get('_animate')._block._custom._items.length; i < l; i++) {
            this.customItems.push(Adapt$1.course.get('_animate')._block._custom._items[i]);
          }
        }
      }
  ...
  var AnimateComponentView = __AMD("extensions/adapt-animate/js/animate-componentView", class AnimateComponentView extends Backbone.View {
    initialize() {
      this.listenTo(Adapt$1, 'remove', this.removeInViewListeners);
      this.listenTo(Adapt$1, 'popup:closed', this.notifyClosed);
      this.render();
    ...
    render() {
      ...
      if (Adapt$1.course.get('_animate')._component._completeElement._isEnabled) {
        this.completeElementEnabled = true;
        this.completeElementEffect = Adapt$1.course.get('_animate')._component._completeElement._effect;
        this.completeElementDelay = Adapt$1.course.get('_animate')._component._completeElement._delay;
      }
      ...
      if (Adapt$1.course.get('_animate')._component._title._isEnabled) {
        this.titleEnabled = true;
        this.titleEffect = Adapt$1.course.get('_animate')._component._title._effect;
        this.titleDelay = Adapt$1.course.get('_animate')._component._title._delay;
      }
      ...
      if (Adapt$1.course.get('_animate')._component._body._isEnabled) {
        this.bodyEnabled = true;
        this.bodyEffect = Adapt$1.course.get('_animate')._component._body._effect;
        this.bodyDelay = Adapt$1.course.get('_animate')._component._body._delay;
      }
      ...
      if (Adapt$1.course.get('_animate')._component._instruction._isEnabled) {
        this.instructionEnabled = true;
        this.instructionEffect = Adapt$1.course.get('_animate')._component._instruction._effect;
        this.instructionDelay = Adapt$1.course.get('_animate')._component._instruction._delay;
      }
      ...
      if (Adapt$1.course.get('_animate')._component._custom._isEnabled) {
        this.customEnabled = true;
        this.customElement = Adapt$1.course.get('_animate')._component._custom._element;
        this.customEffect = Adapt$1.course.get('_animate')._component._custom._effect;
        this.customDelay = Adapt$1.course.get('_animate')._component._custom._delay;

        if (Adapt$1.course.get('_animate')._component._custom._items) {
          for (let i = 0, l = Adapt$1.course.get('_animate')._component._custom._items.length; i < l; i++) {
            this.customItems.push(Adapt$1.course.get('_animate')._component._custom._items[i]);
          }
        }
      }
  ...
  class Animate extends Backbone.Controller {
    initialize() {
      this.listenToOnce(Adapt$1, 'app:dataReady', this.onAppDataReady);
    }

    onAppDataReady() {
      this.listenTo(Adapt$1.config, 'change:_activeLanguage', this.onLangChange);
      if (!Adapt$1.course.get('_animate')) return;

      if (Adapt$1.course.get('_animate')._isEnabled) {
        this.setupAnimate();
        this.setupListeners();
      }
    }
    ...
    removeListeners() {
      ...
      this.stopListening(Adapt$1.config, 'change:_activeLanguage', this.onLangChange);
    }

    notifyOpened() {
      Adapt$1.animate.notifyIsOpen = true;
    }

    notifyClosed() {
      Adapt$1.animate.notifyIsOpen = false;
    }

    setupAnimate() {
      Adapt$1.animate.notifyIsOpen = false;

      if (Adapt$1.course.get('_animate')._article._isEnabled) {
        Adapt$1.animate.animateArticleEnabled = Adapt$1.course.get('_animate')._article._isEnabled;
      } else {
        Adapt$1.animate.animateArticleEnabled = false;
      }

      if (Adapt$1.course.get('_animate')._block._isEnabled) {
        Adapt$1.animate.animateBlockEnabled = Adapt$1.course.get('_animate')._block._isEnabled;
      } else {
        Adapt$1.animate.animateBlockEnabled = false;
      }

      if (Adapt$1.course.get('_animate')._component._isEnabled) {
        Adapt$1.animate.animateComponentEnabled = Adapt$1.course.get('_animate')._component._isEnabled;
      } else {
        Adapt$1.animate.animateComponentEnabled = false;
      }
    }
    ...
    onArticleReady(view) {
      if (view.model && Adapt$1.animate.animateArticleEnabled) {
        new AnimateArticleView({
          model: view.model
        });
    ...
    onBlockReady(view) {
      if (view.model && Adapt$1.animate.animateBlockEnabled) {
        new AnimateBlockView({
          model: view.model
        });
      } else if (view.model && view.model.get('_animate') && view.model.get('_animate')._isEnabled) {
        new AnimateBlockView({
    ...
    onComponentReady(view) {
      if (view.model && Adapt$1.animate.animateComponentEnabled) {
        new AnimateComponentView({
          model: view.model
        });
      } else if (view.model && view.model.get('_animate') && view.model.get('_animate')._isEnabled) {
        new AnimateComponentView({
  ...
  __AMD("extensions/adapt-animate/js/adapt-animate", Adapt$1.animate = new Animate());

  var BackgroundSwitcherBlockView = __AMD("extensions/adapt-backgroundSwitcher/js/BackgroundSwitcherBlockView", class BackgroundSwitcherBlockView extends Backbone.View {
    className() {
    ...
    play() {
      ...
      if (Adapt$1.backgroundSwitcher.lowBandwidth) return;
      if (Adapt$1?.visua11y?.noAnimations) return;
      this.video.play();
    }
    ...
    initialize(_ref) {
      ...
      this.onBlockInView();
      this.blockView.$el.addClass('has-background-switcher-image').on('onscreen.backgroundswitcher', this.onBlockInView);
    }

    renderVideo() {
      const videoTag = Adapt$1.backgroundSwitcher.getVideoTag();
      videoTag.loop = true;
      videoTag.playsinline = true;
      videoTag.preload = Adapt$1.backgroundSwitcher.config?._preload || 'none';
      videoTag.attributes['aria-hidden'] = true;
      videoTag.src = this._src;
      videoTag.muted = Adapt$1.backgroundSwitcher.isMuted;
      videoTag.load();
    ...
    deactivate() {
      this.$el.addClass('is-deactive').removeClass('is-active');
    }

    forceDeactivate() {
      this.$el.removeClass('is-deactive').addClass('is-deactive-force');
    }
    ...
    updateAttributes() {
      Object.entries(this.attributes()).forEach(_ref2 => {
    ...
    onRemove() {
      ...
      if (videoTag) {
        videoTag.removeEventListener('timeupdate', this.onTimeUpdate);
        Adapt$1.backgroundSwitcher.releaseVideoTag(videoTag);
      }
    ...
    static addRecord(view) {
      ...
      const record = this.records.find(_ref3 => {
        let {
          view: recordView
        } = _ref3;
    ...
    static setDirection(direction) {
      $('.backgroundswitcher__container').toggleClass('forward', direction === 'forward').toggleClass('backward', direction === 'backward');
    }
    ...
    static activeDirection(view) {
      ...
      return previous.measurement.top < current.measurement.top || previous.measurement.top === current.measurement.top && previous.measurement.left < current.measurement.left ? 'forward' : 'backward';
    }

    static getPrevious() {
      return this.records.find(_ref4 => {
        let {
          isActive
        } = _ref4;
        return isActive;
    ...
    static getCurrent() {
      ...
      const threshold = Adapt$1.backgroundSwitcher.config?._inviewThreshold ?? 80;
      const onScreens = this.records.filter(_ref5 => {
        let {
          measurement: {
            percentFromTop,
            percentFromBottom,
        ...
        return onscreen && percentFromTop < threshold && percentFromBottom < threshold && percentFromRight < threshold && percentFromLeft < threshold;
      });
      ...
      const lowestPostivePercentFromBottom = this.records.reduce((lowestPostivePercentFromBottom, record) => {
        ...
        return lowestPostivePercentFromBottom.measurement.percentFromBottom < record.measurement.percentFromBottom ? lowestPostivePercentFromBottom : record;
      }, null);
  ...
  var BackgroundSwitcherPageView = __AMD("extensions/adapt-backgroundSwitcher/js/BackgroundSwitcherPageView", class BackgroundSwitcherPageView extends Backbone.View {
    className() {
    ...
    onBlockViewPostRender(view) {
      ...
      const backgroundSwitcherBlockView = new BackgroundSwitcherBlockView({
        model: view.model,
        blockView: view
      });
  ...
  class BackgroundSwitcher extends Backbone.Controller {
    ...
    get config() {
      return Adapt$1.course.get('_backgroundSwitcher');
    }

    onDataReady() {
      this.isMuted = this.config?._isMuted ?? false;
      const hasBackgroundSwitcher = data$1.some(model => model.get('_backgroundSwitcher')?._isEnabled === true);
    ...
    applyMute() {
      this._videoTags?.forEach(tag => tag.muted = Adapt$1?.visua11y?.noBackgroundImages || this._isMuted);
    }
    ...
    applyNoAnimation() {
      ...
      Adapt$1?.visua11y?.noAnimations ? view.pause() : view.play();
    }
    ...
    set lowBandwidth(value) {
      ...
      Adapt$1.trigger('backgroundSwitcher:lowBandwidth', this._lowBandwidth);
    }

    get maxVideos() {
      const contentObjects = Adapt$1.course.findDescendantModels('contentobject');
    ...
    firstClick(event) {
      ...
      ___default["default"].delay(this.pauseAll, 100);
    }
    ...
    setUpClickJack() {
      ___default["default"].bindAll(this, 'firstClick', 'pauseAll');
  ...
  __AMD("extensions/adapt-backgroundSwitcher/js/adapt-backgroundSwitcher", Adapt$1.backgroundSwitcher = new BackgroundSwitcher());
  ...
  class BackgroundVideoView extends Backbone.View {
    ...
    initialize() {
      this.render(device$1.screenSize);
      Adapt$1.on('device:changed', this.render, this);
    }
  ...
  var BackgroundVideoView$1 = __AMD("extensions/adapt-backgroundVideo/js/backgroundVideoView", BackgroundVideoView);

  class BackgroundVideo extends Backbone.Controller {
    initialize() {
      this.listenTo(Adapt$1, 'app:dataReady', this._onDataReady);
    }
    ...
    onPostRender(view) {
      ...
      const backgroundVideoView = new BackgroundVideoView$1({
        model: viewModel
      });
  ...
  __AMD("extensions/adapt-backgroundVideo/js/adapt-backgroundVideo", new BackgroundVideo());
  ...
  var LottieInteractivityBlockView = __AMD("extensions/adapt-blocklottieInteractivity/js/LottieInteractivityBlockView", LottieInteractivityView);
  ...
  class LottieInteractivityModel extends Backbone.Controller {
    ...
    onPostRender(view) {
      ...
      const lottieInteractivityBlockView = new LottieInteractivityBlockView({
        model: viewModel
      });
  ...
  __AMD("extensions/adapt-blocklottieInteractivity/js/adapt-blocklottieInteractivity", new LottieInteractivityModel());

  $("body").on('click', '.print-button', function () {
    var certConfig = Adapt$1.course.get('_certificate');
    var course = Adapt$1.course.get("displayTitle");
    Adapt$1.offlineStorage.get('learnerinfo').name;
  ...
  function getName() {
    let scormname = pipwerks__default["default"].SCORM.API.get().LMSGetValue('cmi.core.student_name');
    let name = scormname.replaceAll(',', '');
    var nameID = {};
    var scorm = pipwerks__default["default"].SCORM.version == '1.2';
    nameID.learnerName = scorm ? name : pipwerks__default["default"].SCORM.API.get().LearnerName;
    nameID.learnerID = scorm ? pipwerks__default["default"].SCORM.API.get().LMSGetValue('cmi.core.student_id') : pipwerks__default["default"].SCORM.API.get().learnerID;
    console.log();
    return nameID;
  }
  ...
  const helpers = {
    resources_has_type(resources, type, block) {
      const hasType = resources.some(_.matcher({
        _type: type
      }));
  ...
  var LogoView = __AMD("extensions/adapt-logo/js/logoView", class LogoView extends Backbone.View {
    className() {
    ...
    initialize() {
      this.listenTo(Adapt$1.config, 'change:_activeLanguage', this.remove);
      this.listenTo(Adapt$1, 'device:changed', this.setupLogo);
      this.render();
    }
    ...
    setupLogo() {
      this.deviceSize = Adapt$1.device.screenSize;
      this.image = "";
      this.title = "";
    ...
    onClick(event) {
      const currentId = Adapt$1.location._currentId;
      const parentId = Adapt$1.contentObjects.findWhere({
        _id: currentId
      }).get('_parentId');
      if (parentId === "course") return;

      if (this.model.get('_link')._parentPage) {
        Adapt$1.router.navigateToParent();
      }
    }
  ...
  class Logo extends Backbone.Controller {
    ...
    onAppDataReady() {
      this.listenTo(Adapt$1.config, 'change:_activeLanguage', this.onLangChange);
      if (!Adapt$1.course.get('_logo')) return;

      if (Adapt$1.course.get('_logo')._isEnabled) {
        this.setupLogo();
        this.setupListeners();
      }
    }
    ...
    setupLogo() {
      this.config = Adapt$1.course.get('_logo');
    }

    setupListeners() {
      this.listenTo(Adapt$1, 'navigationView:postRender', this.renderLogoView);
    }

    removeListeners() {
      this.stopListening(Adapt$1, 'navigationView:postRender', this.renderLogoView);
      this.stopListening(Adapt$1.config, 'change:_activeLanguage', this.onLangChange);
    }
  ...
  __AMD("extensions/adapt-logo/js/adapt-logo", Adapt$1.logo = new Logo());
  ...
  class ScrollTopView extends Backbone.View {
    ...
    render() {
      ReactDOM__default["default"].render(React__default["default"].createElement(templates.scrollTop, this.model.toJSON()), this.el);
    }

  }
  var ScrollTopView$1 = __AMD("extensions/adapt-scrollTop/js/ScrollTopView", ScrollTopView);

  class ScrollTop extends Backbone.Controller {
    initialize() {
      this.listenTo(Adapt$1, 'pageView:postRender menuView:postRender', this.onPageRender);
    }

    onPageRender(view) {
      if (this.scrollTop) this.scrollTop.remove();
      const config = Adapt$1.course.get('_scrollTop');
      if (!config || !config._isEnabled) return;
      const model = new Backbone.Model(config);
      this.scrollTop = new ScrollTopView$1({
        model
      });
  ...
  __AMD("extensions/adapt-scrollTop/js/adapt-scrollTop", new ScrollTop());
  ...
  var SplashScreenView = Backbone.View.extend({
    ...
    removeView: function () {
      Adapt$1.offlineStorage.set('_splashScreen', true);
  ...
  var SplashScreenView$1 = __AMD("extensions/adapt-splashScreen/js/splashScreenView", SplashScreenView);

  function createDrawer() {
    if (!!Adapt$1.offlineStorage.get('_splashScreen')) return;
    var splashScreen = Adapt$1.course.get('_splashScreen');
    if (!splashScreen || !splashScreen._isEnabled) return;
    var splashScreenView = new SplashScreenView$1({
      model: {
        _classes: splashScreen._classes,
        _title: splashScreen._title,
        _body: splashScreen._body,
        _button: splashScreen._button,
        _graphic: splashScreen._graphic,
        _images: splashScreen._images
      }
    });
    $("body").append(splashScreenView.$el);
  }

  Adapt$1.once('adapt:start', createDrawer);
  ...
  register("accordion", function Accordion(props) {
    ...
    return React__default["default"].createElement("div", {
      ...
      return React__default["default"].createElement("div", {
        className: classes(['accordion-item', 'js-accordion-item', _graphic?.src && 'has-image', _classes]),
        key: _index,
        "data-index": _index
      }, React__default["default"].createElement("div", {
        role: "heading",
        ...
        className: "aria-label"
      }, `${_isVisited ? visited + '. ' : ''}${compile(title)}`), React__default["default"].createElement("span", {
  ...
  register("textinput", function TextInput(props) {
    ...
    return React__default["default"].createElement("div", {
      ...
      return React__default["default"].createElement("div", {
        ...
        htmlFor: `${_id}-${index}`,
        "aria-label": prefix
      }, html(compile(prefix)))), React__default["default"].createElement("div", {
  ...
  register("flex", function Flex(props) {
    const visited = Adapt$1.course.get('_globals')?._accessibility?._ariaLabels.visited;
    const {
      _id,
      _ariaLevel,
    ...
    return React__default["default"].createElement("div", {
      className: "component__inner flex__inner"
    }, React__default["default"].createElement(templates.header, props), React__default["default"].createElement("div", {
      className: "component__widget flex__widget"
    }, props._items.map((_ref, index) => {
      let {
        _graphic,
        _classes,
      ...
      return React__default["default"].createElement("div", {
        className: classes(['flex-item', 'js-flex-item', _isActive && 'is-active', _classes]),
        key: _index,
        "data-index": _index,
        style: {
        ...
        className: classes(['flex-item__btn', 'js-toggle-item', _isVisited && 'is-visited', _isActive ? 'is-open is-selected' : 'is-closed']),
        onClick: onClick,
        onMouseOver: onMouseOver,
        "aria-expanded": _isActive.toString(),
        "aria-controls": `${_id}-${index}-flex-button-panel`
      }, React__default["default"].createElement("span", {
        className: "flex-item__btn-inner"
      }, React__default["default"].createElement("span", {
        className: "flex-item__icon"
      }, React__default["default"].createElement("span", {
        className: "icon",
        "aria-hidden": "true"
      })), React__default["default"].createElement("span", {
        className: "flex-item__title"
      }, React__default["default"].createElement("span", {
        className: "aria-label"
      }, `${_isVisited ? visited + '. ' : ''}${compile(title)}`), React__default["default"].createElement("span", {
        className: "flex-item__title-inner",
        "aria-hidden": "true",
        dangerouslySetInnerHTML: {
          __html: compile(title)
        }
        ...
        className: "flex-item__content-inner"
      }, React__default["default"].createElement("span", {
        className: "flex-item__title"
      }, React__default["default"].createElement("span", {
        className: "flex-item__title-inner",
        ...
        className: "flex-item__body"
      }, React__default["default"].createElement("div", {
        className: "flex-item__body-inner",
        dangerouslySetInnerHTML: {
          __html: compile(body)
        }
      })))));
  ...
  register("graphicCompare", function GraphicCompare(props) {
    const {
      _id,
      _graphic1,
      _graphic2,
    ...
    const widgetEl = React.useRef(null);
    return React__default["default"].createElement("div", {
      className: "component__inner graphiccompare__inner"
    }, React__default["default"].createElement(templates.header, props), React__default["default"].createElement("div", {
      className: "component__widget graphiccompare__widget",
      ref: widgetEl
    }, React__default["default"].createElement("div", {
      className: "graphiccompare__container"
    }, React__default["default"].createElement("div", {
      ...
      className: "graphiccompare__image graphiccompare__image-1"
    }, React__default["default"].createElement("img", {
      src: _graphic1.src,
      "aria-label": a11y$1.normalize(_graphic1.alt),
      ...
      style: {
        maxWidth: widgetEl.current ? widgetEl.current.offsetWidth : '100%'
      },
      src: _graphic2.src,
      "aria-label": a11y$1.normalize(_graphic2.alt),
      "aria-hidden": !_graphic2.alt,
      loading: "eager"
    })), React__default["default"].createElement("label", null, React__default["default"].createElement("span", {
      className: "aria-label"
    }, compile(_globals._components?._graphicCompare?.ariaLabel)), React__default["default"].createElement("input", {
  ...
  register("vertical-items", function VerticalItems(_ref) {
    let {
      top,
      _items,
      bottom,
  ...
  register("backgroundvideo", function BackgroundVideo(props) {
    const {
      _backgroundVideo,
      _screenSize
    } = props;
    ...
    if (_screenSize !== 'small') {
      return React__default["default"].createElement(UseVideo, null);
    }

    return React__default["default"].createElement(UseGraphic, null);
  });
  ...
  register("scrollTop", function NavigationLogo(props) {
    const {
      _button
    } = props;
    ...
    return React__default["default"].createElement("button", {
      ...
      className: "icon icon-controls-up"
    }));
  });
